...
\section{2-Graphs} %todo: good title?
...
\begin{figure} [htpb]
	...
	\draw[edge,color=red,opacity=0.5,line width=45pt] (v2) -- (v3);
...
This thesis mostly deals with a generalized form of simple graphs, namely hypergraphs.
